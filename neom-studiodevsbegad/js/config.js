...
// ============================================================
//  ويب هوك ديسكورد — بيتبعتله إشعار أول ما مهمة تتسند لمطوّر
//  تجيبه من: إعدادات القناة في ديسكورد ← Integrations ← Webhooks
//  سيبه فاضي ("") لو عايز توقف الإشعارات.
// ============================================================
export const DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1523311021735936055/evD1y2nYJOGp1Y4dQhvcd93ybe68T769hhFeC7YTywRjXHReSfPKajtCVUxGLQnqAdXK";
